...
/**
 * This is the extension manager of the Atom extension.
 */
public class AtomManager extends GeneratedAtomManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AtomManager.class.getName());
	...
	{
		return (AtomManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AtomConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AtomManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AtomManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AtomManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AtomManager called, current tenant: " + getTenant().getTenantID());
		}
	}
