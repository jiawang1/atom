...
public final class AtomConstants extends GeneratedAtomConstants
{
	...
	public static final String COMPRESS_CSS_KEY = "combindcss";
	public static final String COMPRESS_JS_KEY = "combindjs";
	public static final String COMPRESS_KEY = "combind";
}
