...
/**
 * Provides necessary meta information about the atom hmc extension.
 * 
 * 
 * @version ExtGen v5.6.0.0-SNAPSHOT
 */
public class AtomHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AtomHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.atom.hmc.locales";
